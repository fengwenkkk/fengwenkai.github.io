...
#ifndef DlgSelectUserH
#define DlgSelectUserH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TDialogSelectUser : public TDialogForm
{
...
public:     // User declarations
    __fastcall TDialogSelectUser(TComponent* Owner);

    VECTOR<UINT32>& __fastcall GetSelectUser(){return m_vUser;};
    void __fastcall InitVideoUser(IntSet &vSelectedUser);
};
//---------------------------------------------------------------------------
extern PACKAGE TDialogSelectUser *DialogSelectUser;
//---------------------------------------------------------------------------
#endif
