...
//---------------------------------------------------------------------------
class TFormAlarm : public TSubForm
{
__published:    // IDE-managed Components
    TcxPageControl *pcMain;
    TTimer *TimerInit;
    TcxTabSheet *tsHistoryAlarm;
    TcxTabSheet *tsAlarmReport;
    TcxTabSheet *tsActiveAlarm;
...
__fastcall TFormAlarm(TComponent* Owner);

};
//---------------------------------------------------------------------------
extern PACKAGE TFormAlarm *FormAlarm;
//---------------------------------------------------------------------------
#endif
