...
#ifndef FrmAlarmReportH
#define FrmAlarmReportH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormAlarmReport : public TSubForm
{
__published:    // IDE-managed Components
    ...
    void __fastcall gbMainMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift,
          int X, int Y);
private:    // User declarations
    virtual void __fastcall InitSkin(){};

    void __fastcall OnGetAlarmStatRsp(UINT32 ulSeqID, GJson &Json);

public:     // User declarations

	__fastcall TFormAlarmReport(TComponent* Owner);
    void __fastcall RefreshData();
};
//---------------------------------------------------------------------------
extern PACKAGE TFormAlarmReport *FormAlarmReport;
//---------------------------------------------------------------------------
#endif
