...
extern void StartP2PCallRecord(UINT32 ulUserID, UINT32 ulRecType, UINT32 ulRecCallType);
extern void StopP2PCallRecord(UINT32 ulUserID);
extern void StartGroupCallRecord(INT64 i64GroupID, UINT32 ulRecType);
extern void StopGroupCallRecord(INT64 i64GroupID);
extern void UpdateGroupCallRecord(INT64 i64GroupID);
