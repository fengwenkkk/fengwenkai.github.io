...
__published:    // IDE-managed Components
    ...
    TcxTreeListColumn *tlMainColumn10;
...
private:    // User declarations
    ...
    void __fastcall InitView(UINT32 ulRecType, VECTOR<ESDK_REC_FILE_INFO_T> &vInfo);
