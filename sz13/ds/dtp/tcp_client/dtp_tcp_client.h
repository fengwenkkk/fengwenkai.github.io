#ifndef _DTP_TCP_CLIENT_H
#define _DTP_TCP_CLIENT_H

#include "g_include.h"
#include "dtp_public.h"
#include "DTPClient.h"

class DTPTCPClient:public DTPClient
{
public:
    static DTPTCPClient* New(DTP_CLIENT_CFG_T *pstClientCfg, DTPClientMsgHandler *pMsgHandle, GMemAlloc *pMemAlloc);
    ~DTPTCPClient();
    ...
    BOOL TcpSend(SOCKET stSocket, VOID *pvMsg, UINT32 ulMsgLen, BOOL bNeedLock=TRUE);
...
private:
    ...
    DTPTCPClient(DTPClientMsgHandler *pMsgHandle, GMemAlloc *pMemAlloc);
