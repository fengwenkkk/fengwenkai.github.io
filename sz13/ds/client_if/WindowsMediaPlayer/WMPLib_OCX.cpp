...
// $Rev: 92848 $
// File generated on 2021/9/14 9:27:16 from Type Library described below.
...
// *********************************************************************//
int   TWindowsMediaPlayer::EventDispIDs[63] = {
    ...
    0x00001974, 0x00001975, 0x00001976, 0x0000197F, 0x00001977, 0x00001978,
    0x00001979, 0x0000197A, 0x0000197B, 0x0000197C, 0x0000197D, 0x0000197E,
    0x000016C0, 0x000016C1, 0x000016C2};

Vcl::Olectrls::TControlData2 TWindowsMediaPlayer::CControlData =
{
...
{
   delete new TWindowsMediaPlayer((System::Classes::TComponent*)(0));
};
...
void __fastcall TWMPButtonCtrl::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5120: {
...
void __fastcall TWMPSliderCtrl::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5430: {
...
void __fastcall TWMPVideoCtrl::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5720: {
...
IWMPSkinListPtr& TWMPSkinList::GetDefaultInterface()
{
  if (!m_DefaultIntf)
    Connect();
  return m_DefaultIntf;
...
_di_IUnknown __fastcall TWMPSkinList::GetDunk()
{
  _di_IUnknown diUnk;
  if (m_DefaultIntf) {
    IUnknownPtr punk = m_DefaultIntf;
...
void __fastcall TWMPSkinList::Connect()
{
  if (!m_DefaultIntf) {
    _di_IUnknown punk = GetServer();
    m_DefaultIntf = punk;
...
void __fastcall TWMPSkinList::Disconnect()
{
  if (m_DefaultIntf) {
...
void __fastcall TWMPSkinList::BeforeDestruction()
{
  Disconnect();
}

void __fastcall TWMPSkinList::ConnectTo(IWMPSkinListPtr intf)
{
  Disconnect();
  m_DefaultIntf = intf;
  if (ServerData->EventIID != GUID_NULL)
...
void __fastcall TWMPSkinList::InitServerData()
{
  static Vcl::Oleserver::TServerData sd;
  sd.ClassID = CLSID_WMPSkinList;
  sd.IntfIID = __uuidof(IWMPSkinList);
  sd.EventIID= GUID_NULL;
  ServerData = &sd;
}

void __fastcall TWMPSkinList::updateBasketColumns(void)
{
  GetDefaultInterface()->updateBasketColumns();
}

void __fastcall TWMPSkinList::highContrastChange(void)
{
  GetDefaultInterface()->highContrastChange();
}
...
void __fastcall TWMPRegionalButton::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5360: {
...
void __fastcall TWMPCustomSliderCtrl::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5020: {
...
VARIANT_BOOL __fastcall TWMPTextCtrl::get_disableGlassBlurBackground(void)
{
  VARIANT_BOOL pVal;
  OLECHECK(GetDefaultInterface()->get_disableGlassBlurBackground((VARIANT_BOOL*)&pVal));
  return pVal;
}

void __fastcall TWMPTextCtrl::set_disableGlassBlurBackground(VARIANT_BOOL pVal/*[in]*/)
{
  GetDefaultInterface()->set_disableGlassBlurBackground(pVal/*[in]*/);
}
...
void __fastcall TWMPCore::InvokeEvent(int id, Vcl::Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 5001: {
...
void __fastcall PACKAGE Register()
{
  ...
  System::Classes::TComponentClass cls_svr[] = {
                              ...
                              __classid(Wmplib_tlb::TWMPSkinList),
