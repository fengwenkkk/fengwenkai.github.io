...
__published:    // IDE-managed Components
    ...
    TcxButtonEdit *edtDir;
    TcxLabel *cxLabel1;
    TcxTextEdit *edtFileType;
    TcxLabel *cxLabel3;
    TcxCheckBox *cbConvertTab;
    TcxCheckBox *cbTrimRight;
    TcxCheckBox *cbUnixFile;
    TcxCheckBox *cbAnsiFile;
    TcxButton *cxButton1;
    TcxButton *btnClose;
    ...
    void __fastcall cbFormatPropertiesChange(TObject *Sender);
...
private:    // User declarations
    ...
    void __fastcall GetFilePostfix(VECTOR<AnsiString> &vFilePostfix);
