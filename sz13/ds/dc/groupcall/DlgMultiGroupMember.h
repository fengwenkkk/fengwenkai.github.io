...
#ifndef DlgMultiGroupMemberH
#define DlgMultiGroupMemberH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TDialogMultiGroupMember : public TDialogForm
{
...
public:     // User declarations
    __fastcall TDialogMultiGroupMember(TComponent* Owner);
    void __fastcall Init(INT64 i64GroupID, VECTOR<INT64> &vMember);
    void __fastcall GetMember(VECTOR<INT64> &vAddMember, VECTOR<INT64> &vDelMember);
};
//---------------------------------------------------------------------------
extern PACKAGE TDialogMultiGroupMember *DialogMultiGroupMember;
//---------------------------------------------------------------------------
#endif
