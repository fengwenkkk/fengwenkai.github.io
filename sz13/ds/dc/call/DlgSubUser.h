...
//---------------------------------------------------------------------------
class TDialogSubUser : public TDialogForm
{
...
public:     // User declarations
    __fastcall TDialogSubUser(TComponent* Owner);

    void __fastcall Init(IntSet &sUser, IntSet &sHideUser, BOOL bVideoUserOnly=FALSE);
    void __fastcall Init(IntSet &sUser, BOOL bVideoUserOnly=FALSE);
    void __fastcall Get(IntSet &sUser);
};
//---------------------------------------------------------------------------
extern PACKAGE TDialogSubUser *DialogSubUser;
//---------------------------------------------------------------------------
#endif
