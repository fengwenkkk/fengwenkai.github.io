...
//---------------------------------------------------------------------------
class TFormInbox : public TSubForm
{
__published:    // IDE-managed Components
    ...
    TdxBarButton *pmiNewSDS;
    TdxBarButton *pmiReplySDS;
    TdxBarPopupMenu *pmMain;
    void __fastcall gbMainDblClick(TObject *Sender);
    ...
    void __fastcall pmiReplySDSClick(TObject *Sender);
    void __fastcall pmiNewSDSClick(TObject *Sender);
...
public:     // User declarations
    __fastcall TFormInbox(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormInbox *FormInbox;
//---------------------------------------------------------------------------
#endif
