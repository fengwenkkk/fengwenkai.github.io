...
//---------------------------------------------------------------------------
class TDialogExit : public TDialogForm
{
__published:    // IDE-managed Components
    ...
    TdxBevel *dxBevel1;
    TcxImage *cxImage1;
    TcxRadioButton *rbExit;
    TcxRadioButton *rbLogout;
    TcxRadioButton *rbLock;
...
public:     // User declarations
    __fastcall TDialogExit(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TDialogExit *DialogExit;
//---------------------------------------------------------------------------
#endif
