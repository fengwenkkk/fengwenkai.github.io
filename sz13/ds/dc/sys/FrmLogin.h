...
__published:    // IDE-managed Components
    ...
    TTimer *TimerAutoLogin;
    void __fastcall btnLoginClick(TObject *Sender);
    void __fastcall btnExitClick(TObject *Sender);
    void __fastcall FormShow(TObject *Sender);
    void __fastcall edtDCOperatorPwdKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
    void __fastcall cbDCTypePropertiesChange(TObject *Sender);
    void __fastcall edtPwdPropertiesChange(TObject *Sender);
    void __fastcall edtDCOperatorIDPropertiesChange(TObject *Sender);
    void __fastcall edtDCOperatorIDKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
    void __fastcall TimerAutoLoginTimer(TObject *Sender);
    void __fastcall cbDepotIDPropertiesEditValueChanged(TObject *Sender);
...
private:    // User declarations
    ...
    void __fastcall Login(bool bShowErrMsg);
    void __fastcall LoginReady();
    bool __fastcall DCLoginCheck(bool bShowErrMsg);
