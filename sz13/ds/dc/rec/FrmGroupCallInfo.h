...
#ifndef FrmGroupCallInfoH
#define FrmGroupCallInfoH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormGroupCallInfo : public TSubForm
{
__published:    // IDE-managed Components
    TcxTreeList *tlMain;
    TcxTreeListColumn *ColumnIndex;
    TcxTreeListColumn *ColumnTime;
    TcxTreeListColumn *ColumnCallType;
    TcxGroupBox *gbCtrl;
    TcxButton *btnQuery;
    TcxLabel *cxLabel1;
    ...
    void __fastcall ColumnCallTypeGetDisplayText(TcxTreeListColumn *Sender, TcxTreeListNode *ANode,
          UnicodeString &Value);
...
public:     // User declarations
    __fastcall TFormGroupCallInfo(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormGroupCallInfo *FormGroupCallInfo;
//---------------------------------------------------------------------------
#endif
