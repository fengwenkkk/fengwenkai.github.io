...
//---------------------------------------------------------------------------
class TFormCDR : public TSubForm
{
__published:    // IDE-managed Components
    TcxGroupBox *gbMain;
    TSaveDialog *SaveDialog;
    TcxPageControl *pcMain;
    TcxTabSheet *tsP2PCall;
    TcxTabSheet *tsGroupCall;
...
private:    // User declarations
    ...
    void __fastcall ShowForm(TForm *Form, TcxTabSheet *tsParent);

public:     // User declarations
    __fastcall TFormCDR(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormCDR *FormCDR;
//---------------------------------------------------------------------------
#endif
