...
#ifndef FrmIPHCallInfoH
#define FrmIPHCallInfoH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormIPHCallInfo : public TSubForm
{
__published:    // IDE-managed Components
    TcxTreeList *tlMain;
    TcxTreeListColumn *ColumnIndex;
    TcxTreeListColumn *ColumnApplyTime;
    ...
    TcxTreeListColumn *ColumnStopTime;
...
private:    // User declarations
    ...
    void __fastcall InitView(VECTOR<IPH_TALK_INFO_T> &vInfo);

    void __fastcall OnGetRecFileListRsp(UINT32 ulSeqID, GJson &Json);

public:     // User declarations
    __fastcall TFormIPHCallInfo(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormIPHCallInfo *FormIPHCallInfo;
//---------------------------------------------------------------------------
#endif
